...
export const Stat = ({ info, historyInfo, updateHistoryInfo }: any) => {
        ...
        <div className='container pt-[22px] pb-[19px]'>
            ...
            {openedStat && (
                ...
                <div className="flex justify-between">
                    <div className="flex items-center font-medium select-none cursor-pointer" onClick={e => {
                        setOpenedStat(null);
                    }}>
    ...
    function renderLightningIcon(bg: string, icon: string) {
        return (
            <div className={'flex w-8 h-8 ml-2 rounded-[5px] items-center justify-center' + ` ${bg}`}>
